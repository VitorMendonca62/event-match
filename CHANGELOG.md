...
- Migration `0002_registration_hardening`: estado `converted`, `registration.key_version`, `CHECK`s de coerência e colunas anuláveis para minimização (ADR-018).
...
- Runners de teste aguardam o healthcheck do Compose (`up --wait`).
